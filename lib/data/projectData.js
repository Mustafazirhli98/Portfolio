    ...
    new PROJECT_MODEL("React Native", [
        {
            ...
            _lang: "Javascript",
            _img: "/projects/RickAndMorty/characters1.jpg",
            _subImages: [
        ...
        },
        {
            ...
            _name: "Meals App",
            _lang: "Javascript",
            _img: "/projects/MealsApp/Categories.png",
            _subImages: [
                "/projects/MealsApp/Categories.png",
                "/projects/MealsApp/Meals.png",
                "/projects/MealsApp/MealDetail.png",
                "/projects/MealsApp/Drawer.png",
                "/projects/MealsApp/DeleteFav.png",
    ...
    new PROJECT_MODEL("React", [
        {
            ...
            description: "Luminova Stride is a fictional brand's shopping site where you can purchase futuristic skywalk shoes. The site features animations created using the GSAP library and a user-friendly interface. Additionally, there is a simulation of the payment screen for the purchase process."
        },
        {
            _id: 6,
            _name: "Translator",
